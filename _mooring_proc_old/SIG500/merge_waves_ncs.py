...
folder="/datasets/work/oa-srsalt/work/preqa/SWOT/cal_val/jason_calval/all_mooring_data/proc_1/rec_202603/BASS3B_PTSUVW_202603/SIG500_103017/Exported_Data/S103017A002_BSJSN2502_0000/Burst"
os.chdir(folder)
...
output_file_temp = os.path.join(output_folder, "BASJAS_W_202603_temp.nc")
...
output_file_z = os.path.join(output_folder, "BASJAS_W_202603_swapdims.nc")
